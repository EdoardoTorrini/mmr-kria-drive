...
void CANOpenBridge::loadParameters()
{
    ...
    get_parameter("steer.wheel_rate", this->m_nVelocity);
    get_parameter("steer.inc_per_degree", this->m_fWheelRate);
    get_parameter("steer.max_target", this->m_fIncPerDegree);
    get_parameter("steer.velocity", this->m_fMaxTarget);
}
